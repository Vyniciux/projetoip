    ...
    while (!WindowShouldClose())   
    {
        ...
        BeginDrawing();
            ...
            if(cena==21){
                ...
                if(framesCounter7>300&&framesCounter7<600)DrawText("Sabrina: ?????????  Então você é o saci Perêrê", 200, 850, 60,WHITE);
                ...
                if(framesCounter7>1500&&framesCounter7<1900)DrawText("tenho péssimas memórias.", 200,920, 60, RED);
                if(framesCounter7>1900&&framesCounter7<2200)DrawText("Sabrina: Não farei isso, longe de mim.", 200, 850, 60, WHITE);
                ...
                if(framesCounter7>2600&&framesCounter7<3000)DrawText("Saci: Tenho agido em silêncio, ", 200, 850, 60, RED);
                if(framesCounter7>2600&&framesCounter7<3000)DrawText("não quero que descubram.", 200,920, 60, RED);
                if(framesCounter7>3000&&framesCounter7<3300)DrawText("Sabrina: Porque esse medo todo Isac?", 200, 850, 60, WHITE);
                if(framesCounter7>3300&&framesCounter7<3700)DrawText("Saci: Nem todo mundo é", 200, 850, 60, RED);
                if(framesCounter7>3300&&framesCounter7<3700)DrawText(" como você Sabrina.", 200,920, 60, RED);
                if(framesCounter7>3700&&framesCounter7<4000)DrawText("Sabrina: Seu segredo está guardado comigo.", 200, 850, 60, WHITE);
                if(framesCounter7>4000&&framesCounter7<4300)DrawText("Saci: Obrigado por isso.", 190, 850, 60, RED);
                if(framesCounter7>4300&&framesCounter7<4700)DrawText("Sabrina: Só me garanta que vai cuidar da ", 200, 850, 60, WHITE);
